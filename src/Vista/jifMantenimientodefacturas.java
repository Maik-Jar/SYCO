...
public class jifMantenimientodefacturas extends javax.swing.JInternalFrame {
   ...
   private void Configuraciontabla () {
       ...
       tcmtbFacturacion.getColumn(3).setPreferredWidth(40);
       tcmtbFacturacion.getColumn(4).setPreferredWidth(90);
       ...
       tcmtbFacturacion.getColumn(8).setPreferredWidth(33);
    ...
    private void initComponents() {
        ...
        tbFacturacion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Código", "Descripción", "Cant.", "Precio", "Descto.", "ITBIS", "Monto", ""
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class
            };
        ...
        lbNota.setForeground(new java.awt.Color(240, 240, 240));
        ...
        jdDetalledefacturaLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jdDetalledefacturaLayout.createSequentialGroup()
                ...
                .addGroup(jdDetalledefacturaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(plFacturar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        plBuscarLayout.setHorizontalGroup(
            ...
            .addGroup(plBuscarLayout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addGroup(plBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(plBuscarLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(plBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void btImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btImprimirActionPerformed
        ...
        if (valida.Validacion_Estatus_Factura("factura", "estatus", tfNofactura.getText()) == false) {
            ...
            for (int i = 0; i < dtmtbFacturacion.getRowCount(); i++) {
                articulos.add(dtmtbFacturacion.getValueAt(i, 3));
                articulos.add(dtmtbFacturacion.getValueAt(i, 5));
            }
                ...
                try {
                    ...
                    if (!"Factura de Consumo".equals(lbTipodefactura.getText())) {
                        for (int i = 0; i < tbFacturacion.getRowCount(); i++) {
                            facturascoa = new FacturaSCOA(lbTipodefactura.getText(), tfNCF.getText(), Vigencia_comprobante(), icono.getImage(), "RNC:", tfBusqueda.getText(), tfCliente.getText(), tfTelefono.getText(), tfCodcliente.getText(), currentTime, tfNofactura.getText(), dtmtbFacturacion.getValueAt(i, 1).toString(), dtmtbFacturacion.getValueAt(i, 2).toString(), dtmtbFacturacion.getValueAt(i, 6).toString(), dtmtbFacturacion.getValueAt(i, 3).toString(), dtmtbFacturacion.getValueAt(i, 4).toString(), tfSubtotal.getText(), tfDescto.getText(), tfITBIS.getText(), tfTotal.getText(), cbVenta.getSelectedItem().toString(), cbModopago.getSelectedItem().toString(), tfPagado.getText(), usr.getNombre(), taComentario.getText());
                            coleccion.add(facturascoa);
                        }
                    } else {
                        for (int i = 0; i < tbFacturacion.getRowCount(); i++) {
                            facturascoa = new FacturaSCOA(lbTipodefactura.getText(), tfNCF.getText(), Vigencia_comprobante(), icono.getImage(), cbDocumento.getSelectedItem().toString() + ":", tfBusqueda.getText(), tfCliente.getText(), tfTelefono.getText(), tfCodcliente.getText(), currentTime, tfNofactura.getText(), dtmtbFacturacion.getValueAt(i, 1).toString(), dtmtbFacturacion.getValueAt(i, 2).toString(), dtmtbFacturacion.getValueAt(i, 6).toString(), dtmtbFacturacion.getValueAt(i, 3).toString(), dtmtbFacturacion.getValueAt(i, 4).toString(), tfSubtotal.getText(), tfDescto.getText(), tfITBIS.getText(), tfTotal.getText(), cbVenta.getSelectedItem().toString(), cbModopago.getSelectedItem().toString(), tfPagado.getText(), usr.getNombre(), taComentario.getText());
                            coleccion.add(facturascoa);
                        }
                    }
    ...
    private void tbFacturacionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbFacturacionKeyPressed
        ...
        if (columna == 3) {
            if (dtmtbFacturacion.getValueAt(fila, 3) == null) { // Evalua si la columna "Cantidad" esta vacia.
                dtmtbFacturacion.setValueAt(1, fila, 3); // Si la columna "Cantidad" esta vacia, asigna un valor de 1.
            ...
            try {
                ...
                while (rs.next()) {
                    calculos[0] = rs.getDouble(3); // Captura el precio desde la base de datos.
                    categoria = rs.getString(4); // Captura la categoria del artículo.
                }

                conn.close();

                calculos[1] = Double.parseDouble(dtmtbFacturacion.getValueAt(fila, 3).toString()); // Captura la cantidad de la columna "Cantidad".
                calculos[2] = Double.parseDouble(dtmtbFacturacion.getValueAt(fila, 5).toString()); // Captura el descuento de la columna "Descto".
                calculos[3] = calculos[0] * calculos[1]; // Multiplica el precio por la cantidad.
                if ("Tarro".equals(categoria)) {
                    calculos[4] = Double.parseDouble(calculos[3].toString()) * ITBIS; // Calcula el ITBIS
                    dtmtbFacturacion.setValueAt(calculos[3], fila, 4); // Envia el producto de la multiplicacion (Precio * cantidad).
                    dtmtbFacturacion.setValueAt(calculos[4], fila, 6); // Envia el ITBIS.
                    dtmtbFacturacion.setValueAt((calculos[3] - calculos[2]) + calculos[4], fila, 7); // Envia el resultado de la resta (precio - descto).
                } else {
                    calculos[4] = Double.parseDouble("0.00"); // ITBIS
                    dtmtbFacturacion.setValueAt(calculos[3], fila, 4); // Envia el producto de la multiplicacion (Precio * cantidad).
                    dtmtbFacturacion.setValueAt(calculos[3] - calculos[2], fila, 7); // Envia el resultado de la resta (precio - descto).
                }
        ...
        if (columna == 5) {
            if (dtmtbFacturacion.getValueAt(fila, 5) == null) { // Evalua si la columna "Cantidad" esta vacia.
                dtmtbFacturacion.setValueAt(0.00, fila, 5); // Si la columna "Cantidad" esta vacia, asigna un valor de 1.
                dtmtbFacturacion.fireTableDataChanged(); // Ejecuta el cambio.
            }

            Double[] calculos = new Double[4];

            calculos[0] = Double.parseDouble(dtmtbFacturacion.getValueAt(fila, 4).toString()); // Captura el valor de la columna precio.
            calculos[1] = Double.parseDouble(dtmtbFacturacion.getValueAt(fila, 5).toString()); // Captura el valor de la columna desct.
            calculos[2] = calculos[0] - calculos[1]; // Captura el resultado de precio - descto.
            if ("TA".equals(dtmtbFacturacion.getValueAt(fila, 1).toString().substring(0, 2))) {
                calculos[3] = (calculos[0] - calculos[1]) * ITBIS; // Captura el resultado de precio - descto * ITBIS.
                dtmtbFacturacion.setValueAt(calculos[3], fila, 6); // Envia el ITBIS.
                dtmtbFacturacion.setValueAt(calculos[2] + calculos[3], fila, 7); // Envia el resultado de la resta (precio - descto) + ITBIS.
            } else {
                calculos[3] = Double.parseDouble("0.00"); // ITBIS
                dtmtbFacturacion.setValueAt(calculos[2], fila, 7); // Envia el resultado de la resta (precio - descto).
                dtmtbFacturacion.setValueAt(calculos[3], fila, 6); // Envia el ITBIS.
            }
                ...
                if (tfPagado.getText() == null ? tfTotal.getText() != null : !tfPagado.getText().equals(tfTotal.getText())) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < dtmtbFacturacion.getRowCount(); i++) {
                            ...
                            ps.setInt(3, Integer.parseInt(dtmtbFacturacion.getValueAt(i, 3).toString())); // Envia la cantidad.
                            ps.setDouble(4, Double.parseDouble(dtmtbFacturacion.getValueAt(i, 4).toString())); // Envia el precio.
                            ps.setDouble(5, Double.parseDouble(dtmtbFacturacion.getValueAt(i, 5).toString())); // Envia el descuento.
                            ps.setDouble(6, Double.parseDouble(dtmtbFacturacion.getValueAt(i, 6).toString())); // Envia el ITBIS.
                            ps.setDouble(7, Double.parseDouble(dtmtbFacturacion.getValueAt(i, 7).toString())); // Envia el monto.
    ...
    private void tbMantenimientodefacturasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMantenimientodefacturasMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    do {
                        ...
                        registro[3] = rs.getInt(23); // Cantidad.
                        registro[4] = rs.getDouble(24); // Precio.
                        registro[5] = rs.getDouble(25); // Descuento.
                        registro[6] = rs.getDouble(26); // ITBIS artículo.
                        registro[7] = rs.getDouble(27); // Monto.
                        registro[8] = new JLabel(); // Boton borrar
            ...
            jdDetalledefactura.setSize(835, 620);
            //jdDetalledefactura.setSize(895, 620);
    ...
    private void Buscar_Factura() {
     ...
     private void CalcularTotal() {
        ...
        if (dtmtbFacturacion.getRowCount() > 0) {
            for (int i = 0; i < tbFacturacion.getRowCount(); i++) {
                precio[0] = Double.parseDouble(dtmtbFacturacion.getValueAt(i, 4).toString());
                total[0] += precio[0];
            }
            tfSubtotal.setText(String.valueOf(formatodecimal.format(total[0])));
            
            for (int i = 0; i < tbFacturacion.getRowCount(); i++) {
                precio[1] = Double.parseDouble(dtmtbFacturacion.getValueAt(i, 6).toString());
                total[1] += precio[1];
            }
            tfITBIS.setText(String.valueOf(formatodecimal.format(total[1])));
            
            for (int i = 0; i < tbFacturacion.getRowCount(); i++) {
                precio[2] = Double.parseDouble(dtmtbFacturacion.getValueAt(i, 5).toString());
                total[2] += precio[2];
            }
            tfDescto.setText(String.valueOf(formatodecimal.format(total[2])));
            
            for (int i = 0; i < tbFacturacion.getRowCount(); i++) {
                precio[3] = Double.parseDouble(dtmtbFacturacion.getValueAt(i, 7).toString());
                total[3] += precio[3];
            }
    ...
    private void Actualizar_inventario () {
        ...
        try {
            ...
            for (int i = 0; i < dtmtbFacturacion.getRowCount(); i++) {
                if (cant_pro_fact[i] > Integer.parseInt(dtmtbFacturacion.getValueAt(i, 3).toString())) { // Si la cantidad vieja es mayor que la cantidad nueva.
                    ...
                    if (!(chbPreventa.isSelected())) { // Si el checkbox de Pre-venta no esta seleccionado.
                        ...
                        ps.setInt(2, cant_bd[i] + (cant_pro_fact[i] - Integer.parseInt(dtmtbFacturacion.getValueAt(i, 3).toString()))); // Suma a la cantidad en inventario las cantidades sobrante del artículo en la modificación (Cantidad en inventario + (cantidad vieja - cantidad nueva)).
                        
                        // Ejecución de la consulta SQL.
                        rs = ps.executeQuery();
                    }
                } else if (cant_pro_fact[i] < Integer.parseInt(dtmtbFacturacion.getValueAt(i, 3).toString())) { // Si la cantidad vieja es menor que la cantidad nueva
                    ...
                    if (!(chbPreventa.isSelected())) { // Si el checkbox de Pre-venta no esta seleccionado.
                        ...
                        // Parametros de consulta.
                        ps.setString(1, dtmtbFacturacion.getValueAt(i, 1).toString()); // Envia código.
                        ps.setInt(2, cant_bd[i] - (Integer.parseInt(dtmtbFacturacion.getValueAt(i, 3).toString()) - cant_pro_fact[i])); // Resta a la cantidad en inventario las cantidades faltantes del artículo en la modificación (Cantidad en inventario - (cantidad nueva - cantidad vieja)).
    ...
    private boolean Valida_cantidad() {
        ...
        for (int i = 0; i < dtmtbFacturacion.getRowCount(); i++) {
            try {
                ...
                if (cantidad < Integer.parseInt(dtmtbFacturacion.getValueAt(i, 3).toString()) && !(chbPreventa.isSelected())) {
